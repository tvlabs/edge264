...
* CABAC [context variables](edge264_common.h#L203) are stored in two Global Register Variables if allowed by compiler, reducing reads and writes into the *very frequent* `get_ae` function.
