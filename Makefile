...
edge264$(SUFFIX).o: edge264.c edge264.h edge264_common.h edge264_golomb.c edge264_cabac.c edge264_intra_ssse3.c edge264_residual_ssse3.c edge264_test.c edge264_play.c Makefile
