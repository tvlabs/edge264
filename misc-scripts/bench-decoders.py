...
edge264_gcc, edge264_clang, ffmpeg, libavc, openh264 = [], [], [], [], []
...
print(f'{{"edge264-GCC":{median(edge264_gcc):.1f},"edge264-Clang":{median(edge264_clang):.1f},"FFmpeg":{median(ffmpeg):.1f},"LibAVC":{median(libavc):.1f},"OpenH264":{median(openh264):.1f}}}')
